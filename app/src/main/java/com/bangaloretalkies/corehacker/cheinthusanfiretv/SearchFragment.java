...
public class SearchFragment extends android.support.v17.leanback.app.SearchFragment
    ...
    private SearchAsyncTask searcher;
...
/*            if (item instanceof Video) {
    ...
    public class SearchAsyncTask extends AsyncTask<Boolean, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Boolean... booleen) {
            ...
            List<String> results = chEinthusanSearch.searchMovies (query);
            ArrayObjectAdapter row = new ArrayObjectAdapter();
