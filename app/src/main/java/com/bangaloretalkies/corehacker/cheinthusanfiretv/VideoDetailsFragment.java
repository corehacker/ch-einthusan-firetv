...
public class VideoDetailsFragment extends DetailsFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        currentLang = (String) getActivity()
                .getIntent().getSerializableExtra(DetailsActivity.CURRENT_LANG);
        if (mSelectedMovie != null) {
            ...
            Intent intent = new Intent(getActivity(), ChEinthusanMainActivity.class);
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(DetailsActivity.CURRENT_LANG, currentLang);
                    startActivity(intent);
                } else {
    ...
    private void setupMovieListRow() {
        ...
        List<Movie> list = movieList.getMovieListByLanguage (currentLang);
